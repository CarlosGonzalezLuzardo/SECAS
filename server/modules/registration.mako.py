...
_magic_number = 10
_modified_time = 1510836949.3727813
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer('</h1>\n</div>\n<div class="col-md-6 col-md-offset-3 registration_form top_form" class="block">\n    <form method="post" class="login form">\n        <table class="col-md-12 registration-table">\n            <tr>\n                <td class="col-md-4">')
        __M_writer(str(username_title))
        __M_writer('</td>\n        <td class="col-md-8"><input class="form-control" type="text" name="username" id="username" /></td>\n     </tr>\n       <tr>\n      <td class="col-md-4">')
        ...
        __M_writer('</td>\n        <td class="col-md-8"><input class="form-control" type="text" name="question"/></td>\n       </tr>\n            <tr>\n              <td class="col-md-4">')
...
"""
__M_BEGIN_METADATA
{"uri": "registration.mako", "source_encoding": "utf-8", "filename": "htdocs/registration.mako", "line_map": {"64": 81, "70": 46, "74": 46, "80": 74, "27": 0, "42": 1, "43": 4, "44": 4, "45": 10, "46": 10, "47": 14, "48": 14, "49": 18, "50": 18, "51": 22, "52": 22, "53": 26, "54": 26, "55": 30, "56": 30, "57": 34, "58": 34, "59": 36, "60": 36, "61": 40, "62": 40, "63": 52}}
__M_END_METADATA
"""
