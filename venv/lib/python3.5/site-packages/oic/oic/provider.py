...
class Provider(AProvider):
    ...
    def client_registration_setup2(self, request):
        ...
        reg_uri = ("http://localhost:4200", None)
        _cinfo["redirect_uris"] = []
        _cinfo["redirect_uris"].insert(0, reg_uri)
        _cinfo["response_types"] = "code"
        _cinfo["post_logout_redirect_uris"] = "http://localhost:4200"
        ...
        try:
            self.cdb.sync()
            logger.info("cdb sync")
        except AttributeError as e:  # Not all databases can be sync'ed
            logger.info(e)
            pass
